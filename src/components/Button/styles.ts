...
// ButtonProps를 HTMLButtElement의 HTML 속성을 확장
...
/* size === "md" ? 30 : size === "sm" ? 25 : 40}px; //삼항연산 3일경우 */
// styled.엘리먼트명<속성타임>`스타일목록`
export const Button = styled.button<ButtonProps>`
  ...
  line-height: ${({ primary }) => (primary ? 14 : 13)}px;
  height: ${getHeight}px;
  color: white;
  cursor: pointer;
